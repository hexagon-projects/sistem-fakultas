    ...
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <div class="w-full max-w-3xl mx-auto my-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-center text-center w-1/3">
                        <div class="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center">1
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                ...
                <div class="col-span-1">
                    <div class="flex flex-col gap-1 mb-5 items-start">
                        <span class="text-xs p-2 bg-blue-600 text-white rounded-full my-5">Color Guide Departement</span>
            ...
            <div class="flex items-center justify-between my-5">
                ...
                <button class="py-3 px-5 bg-[#034833] text-white rounded-xl" type="button" onclick="confirmSubmit()">Next</button>
            </div>
            </form>
        </div>
    </div>
