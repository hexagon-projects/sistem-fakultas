      ...
      @method('PUT')
        ...
        <div class="flex flex-col lg:flex-row gap-6">
          ...
          <p class="mt-4 text-sm font-medium text-gray-700">Gambar Desktop Slider (Max Size: 750kb)</p>
            ...
            <label for="dropzone-fil"
            class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition mt-4 ">
            ...
            <input id="dropzone-file" type="file" class="hidden" name="image1" />
          </label>
          ...
          <label for="dropzone-file"
            class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition mt-2">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
              <svg aria-hidden="true" class="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M7 16v-4m0 0l-3 3m3-3l3 3m0-6a4 4 0 014 4v1h2a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3a2 2 0 012-2h2v-1a4 4 0 014-4z" />
            ...
            <input id="dropzone-file" type="file" class="hidden" name="image2" />
          </label>
