<x-layout>
  <div class="container grid px-6 mx-auto mt-8">
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md h-auto">
          <form 
              action="{{ isset($identity) ? route('identity.update', $identity->id) : route('identity.store') }}" 
              method="POST" 
          ...
          >
              ...
              <label class="block text-sm mt-3">
                  ...
                  >{{ old('meta', $identity->meta ?? '') }}</textarea>
              </label>
              ...
              <div class="flex flex-row gap-4 mt-6">
                  ...
                  <div class="mt-4 w-full">
                      <div class="mt-2">
                          <img id="preview-image1" src="{{ isset($identity->image1) ? asset('storage/' . $identity->image1) : '' }}" alt="Preview" class="w-[600px] h-[500px] rounded-md shadow object-cover " />
                      </div>
                  ...
                  <div class="mt-4 w-full">
                      <div class="mt-2">
                          <img id="preview-image2" src="{{ isset($identity->image2) ? asset('storage/' . $identity->image2) : '' }}" alt="Preview" class="w-52 h-52 rounded-md shadow object-cover" />
                      </div>
