<x-layout title="Add Fasilitas">

    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('fasilitas.store') }}" method="post" enctype="multipart/form-data" id="form-departement">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                ...
                <div class="col-span-1">
                    ...
                    <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                        ...
                        <!-- Preview Gambar -->
                        <img id="image5-preview" src="#" alt="Preview" class="absolute inset-0 w-full h-full object-cover hidden z-0 rounded-md" />
                    ...
                    <label for="title1">Image 6 (Max : 1MB)</label>
                    <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                        <input
                            type="file"
                            name="image6"
                        ...
                        <!-- Preview Gambar -->
                        <img id="image6-preview" src="#" alt="Preview" class="absolute inset-0 w-full h-full object-cover hidden z-0 rounded-md" />
    ...
    <script>
        ...
        function removeImage4() {
            const fileInput = document.getElementById('image4');
            const preview = document.getElementById('image4-preview');
            const removeBtn = document.getElementById('remove-btn');
            const uploadText = document.getElementById('upload-text');
