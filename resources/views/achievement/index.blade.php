<x-layout title="Achievement">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('achievement.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
            ...
            <form action="{{ route('achievement.index') }}" method="GET" class="mb-4 flex items-center gap-2 mt-4">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Name Winner</th>
                    ...
                    <tbody class="bg-white divide-y">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {!! $achievement->winner_name ?? '' !!}
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a
                                        href="{{ route('achievement.edit', $achievement->id) }}"
                                    ...
                                    <form action="{{ route('achievement.destroy', $achievement->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
