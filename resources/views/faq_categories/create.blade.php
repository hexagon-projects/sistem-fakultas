<x-layout title="Add FAQs Cateories">

    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('faqcategories.store') }}" method="post" enctype="multipart/form-data" id="form-departement">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-1 gap-5 items-start">

                <div class="col-span-1 md:col-span-2 gap-5">    
                    <h1 class="font-semibold">Add Faqs Categories</h1>
                    <hr class="my-3"> 
