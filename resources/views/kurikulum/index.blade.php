<x-layout title="Kurikulum">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('kurikulum.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
                ...
                <span>Add Kurikulum</span>
            </a>
            <form action="{{ route('kurikulum.index') }}" method="GET" class="mb-4 flex items-center gap-2">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a
                                        href="{{ route('kurikulum.edit', $kurikulum->id) }}"
                                    ...
                                    <form action="{{ route('kurikulum.destroy', $kurikulum->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
            ...
            <div class="py-5">
                {{ $kurikulums->appends(['search' => request('search')])->links() }}
            </div>
        </div>
    </div>
