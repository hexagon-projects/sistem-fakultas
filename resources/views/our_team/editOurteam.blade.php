      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md h-auto">
        ...
        <label class="inline-flex items-center mt-3 mb-3">
          <input 
           ...
           value="{{ old('home', $ourteam->home) }}"
            {{ old('home', $ourteam->home) == '1' ? 'checked' : '' }}
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <div class="flex gap-6 mt-6">
            ...
            <label for="dropzone-file"
                   class="flex flex-col items-center justify-center w-2/3 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition">
            ...
            <div class="w-2/3 flex items-center justify-center">
              @if(isset($ourteam) && $ourteam->image)
                <img src="{{ asset('storage/' . $ourteam->image) }}" 
                     alt="Preview" 
          ...
          <button
            type="submit"
            class="block w-auto px-4 py-2 mt-6 text-sm font-medium text-white hover:bg-gray-900  bg-primary rounded-lg transition-colors"
          >
            Save
          </button>
        </form>
