            ...
            <form action="{{ route('users.index') }}" method="GET" class="mb-4 flex items-center gap-2">
                <input type="text" name="search" placeholder="Cari nama atau email..." value="{{ request('search') }}"
                    ...
                    <div class="flex gap-1">
                        <button type="submit" class="py-2 px-3 text-xs rounded-full bg-[#034833] text-white">
                        ...
                        <a href="{{ route('users.create') }}" class="p-3 bg-[#034833] rounded-full flex items-center w-fit hover:bg-gray-900 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-folder-plus w-3" viewBox="0 0 16 16">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}" alt="Profile" class="w-8 h-8 rounded-full">
