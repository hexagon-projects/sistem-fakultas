    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <div class="flex items-center justify-between mb-2">
            <a href="" class="py-2 px-3 bg-primary rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
                  ...
                  <tr class="text-gray-700">
                    ...
                    <td class="px-1 py-1">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">{{ $legalDocument->name }}</p>
                         
  
                          <div class="flex items-center space-x-4 text-sm mt-7">
                            <a
                              class="flex hover:bg-yellow-400 items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-primary rounded-lg focus:outline-none focus:shadow-outline-gray" href="/legalDocument/{{ $legalDocument->id }}/edit"
                              aria-label="Edit"
                            >
                              <svg
                                class="w-5 h-5"
                            ...
                            href="/legalDocument/{{ $legalDocument->id }}/delete"
                            aria-label="Delete"
