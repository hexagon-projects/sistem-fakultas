<x-layout title="Timeline">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('timeline.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
            ...
            <form action="{{ route('timeline.index') }}" method="GET" class="mb-4 flex items-center gap-2 mt-4">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <form action="{{ route('timeline.destroy', $timeline->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
            ...
            <div class="py-5">
                {{ $timelines->appends(['search' => request('search')])->links() }}
            </div>
        </div>
    </div>
