<x-layout title="faculty">
    ...
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            ...
            <hr class="my-5">
            <form action="{{ route('faculty.update.step3', $faculty->id) }}" method="post" enctype="multipart/form-data" id="form-faculty">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="title4" value="{{ $faculty->title4 }}"
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="description4" id="description" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ $faculty->description4 }}</textarea>
                        @error('description4')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="address" id="detail" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ $faculty->address }}</textarea>
                        @error('address')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="map" value="{{ $faculty->map }}"
                            class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        @error('map')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="link1" value="{{ $faculty->link1 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('link1')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="link2" value="{{ $faculty->link2 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('link2')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="link3" value="{{ $faculty->link3 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('link3')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="link4" value="{{ $faculty->link4 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('link4')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                ...
                <div class="col-span-1">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                            ...
                            <img 
                                id="image-preview" 
                                src="{{ old('image4') ? asset('storage/faculty-image/' . old('image4')) : (isset($faculty) && $faculty->image4 ? asset('storage/' . $faculty->image4) : '#') }}" 
                                alt="Preview" 
                                class="absolute inset-0 w-full h-full object-cover {{ (isset($faculty) && $faculty->image4) ? '' : 'hidden' }} z-0 rounded-md" 
                            />
                            ...
                            <!-- Text Default -->
                            <span id="upload-text" class="text-gray-400 z-0 text-center px-2 {{ (isset($faculty) && $faculty->image4) ? 'hidden' : '' }}">
            ...
            <div class="flex items-center justify-between my-5">
                <a href="{{ route('faculty.step2', $faculty->id) }}" class="py-3 px-5 bg-gray-300 rounded-xl">Back</a>
