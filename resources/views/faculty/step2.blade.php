<x-layout title="Step 2 faculty">
    ...
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <div class="w-full max-w-3xl mx-auto my-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-center text-center w-1/3">
                        ...
                        <p class="mt-2 text-sm font-medium text-gray-700">Informasi faculty</p>
                    </div>
            ...
            <hr class="my-5">
            <form action="{{ route('faculty.update.step2', $faculty->id) }}" method="post" enctype="multipart/form-data" id="form-faculty">
            @csrf
            @method('PUT')
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="statistik1" value="{{ $faculty->statistik1 }}"
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="statistik2" value="{{ $faculty->statistik2 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('statistik2')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="statistik3" value="{{ $faculty->statistik3 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('statistik3')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="statistik4" value="{{ $faculty->statistik4 }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('statistik4')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="title2" value="{{ $faculty->title2 }}"
                            class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        @error('title2')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="description2" id="description" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ $faculty->description2 }}</textarea>
                        @error('description2')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="title3" value="{{ $faculty->title3 }}"
                            class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        @error('title3')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="description3" id="detail" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ $faculty->description3 }}</textarea>
                        @error('description3')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
                ...
                <div class="col-span-1">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                            ...
                            <img 
                                id="image-preview" 
                                src="{{ old('image2') ? asset('storage/faculty-image/' . old('image2')) : (isset($faculty) && $faculty->image2 ? asset('storage/' . $faculty->image2) : '#') }}" 
                                alt="Preview" 
                                class="absolute inset-0 w-full h-full object-cover {{ (isset($faculty) && $faculty->image2) ? '' : 'hidden' }} z-0 rounded-md" 
                            />
                            ...
                            <!-- Text Default -->
                            <span id="upload-text" class="text-gray-400 z-0 text-center px-2 {{ (isset($faculty) && $faculty->image2) ? 'hidden' : '' }}">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                            ...
                            <img 
                                id="image-preview-2" 
                                src="{{ old('image3') ? asset('storage/faculty-image/' . old('image3')) : (isset($faculty) && $faculty->image3 ? asset('storage/' . $faculty->image3) : '#') }}" 
                                alt="Preview" 
                                class="absolute inset-0 w-full h-full object-cover {{ (isset($faculty) && $faculty->image3) ? '' : 'hidden' }} z-0 rounded-md" 
                            />
                            ...
                            <!-- Text Default -->
                            <span id="upload-text-2" class="text-gray-400 z-0 text-center px-2 {{ (isset($faculty) && $faculty->image3) ? 'hidden' : '' }}">
                                Klik untuk pilih gambar
                            </span>
                        </div>
            ...
            <div class="flex items-center justify-between my-5">
                <a href="{{ route('faculty.index') }}" class="py-3 px-5 bg-gray-300 rounded-xl">Back</a>
    ...
    function confirmSubmit() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('form-faculty').submit();
            }
        });
    }
</script>
