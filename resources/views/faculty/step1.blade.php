            ...
            <div class="w-full max-w-3xl mx-auto my-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-center text-center w-1/3">
                        ...
                        <p class="mt-2 text-sm font-medium text-[#5676ff]">Informasi Fakultas</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="tagline" value="{{ $faculty->tagline ?? '' }}"
                            class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        @error('tagline')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="instagram" value="{{ $faculty->instagram ?? '' }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('instagram')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="tiktok" value="{{ $faculty->tiktok ?? '' }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('tiktok')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="facebook" value="{{ $faculty->facebook ?? '' }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('facebook')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="youtube" value="{{ $faculty->youtube ?? '' }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('youtube')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="title1" value="{{ $faculty->title1 ?? '' }}"
                            class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        @error('title1')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="description1" id="description" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ $faculty->description1 ?? '' }}</textarea>
                        @error('description1')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
