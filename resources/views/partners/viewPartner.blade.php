                      ...
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          ...
                          <div class="flex items-center space-x-4 text-sm mt-7">
                            <a
                              class="flex hover:bg-yellow-400 items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-[#034833] rounded-lg" href="/partner/{{ $partner->id }}/edit"
                              aria-label="Edit"
                            >
                              <svg
                                class="w-5 h-5"
