                  ...
                  <tr class="text-gray-700">
                      ...
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          ...
                          <div class="flex items-center space-x-4 text-sm mt-7">
                            ...
                            <form action="{{ route('partner.delete', $partner->id) }}" method="POST" class="inline-block">
                              @csrf
                              @method('DELETE')
                              <a
                    ...
                    <td class="px-4 py-3">
                      <div class="w-28 h-28 md:w-36 md:h-36">
                        <img class="object-cover w-full h-full rounded-lg" src="{{ asset('storage/' . $partner->image) }}" alt="" loading="lazy">
                      </div>
                    </td>
