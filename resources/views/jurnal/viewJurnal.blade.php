<x-layout title="Jurnal">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('jurnal.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
                ...
                <span>Add Jurnal</span>
            </a>
            <form action="{{ route('jurnal.index') }}" method="GET" class="mb-4 flex items-center gap-2 mt-4">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a
                                        href="{{ route('jurnal.edit', $jurnal->id) }}"
                                    ...
                                    <form action="{{ route('jurnal.destroy', $jurnal->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
            ...
            <div class="py-5">
                {{ $jurnals->appends(['search' => request('search')])->links() }}
            </div>
        </div>
    </div>
