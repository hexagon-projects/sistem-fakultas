    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <div class="flex items-center justify-between mb-2">
            <a href="{{ route('category.create') }}" class="py-2 px-3 bg-primary rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
                  ...
                  <tr class="text-gray-700">
                    ...
                    <td class="px-4 py-3">
                      <div class="w-28 h-28 md:w-36 md:h-36">
                        <img class="object-cover w-full h-full rounded-lg" src="{{ asset('storage/' . $category->image) }}" alt="" loading="lazy">
                      </div>
                    </td>
