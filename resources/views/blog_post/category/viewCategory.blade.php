    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <div class="flex items-center gap-5 mb-2">
            <div class="flex gap-2 w-auto px-3 py-[0.4rem] mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-yellow-500 border border-transparent rounded-lg active:bg-[#1d3e34] hover:bg-[#034833] focus:outline-none focus:shadow-outline-purple mb-5">
